...
const projects = [
  ...
  { date: "2024-12", title: "Number IA", tags: ["Learning", "Deep Learning"], description: "An artificial intelligence project implemented in C.", report: "A programming project focused on implementing and experimenting with artificial intelligence concepts in C.", reportUrl: "", github: "https://github.com/TarikOuadjou/Number_IA" },
  { date: "2023-07", title: "Error Correcting Code", tags: ["Theory", "Modeling"], description: "Python implementation and experiments around error-correcting codes.", report: "A Python project exploring how error-correcting codes can detect and recover from corrupted information.", reportUrl: "", github: "https://github.com/TarikOuadjou/Error_Correcting_Code" },
  { date: "2024-02", title: "3DNA", tags: ["Learning", "Machine Learning", "Health"], description: "A CentraleSupélec project based on the 3DNA codebase.", report: "A collaborative academic project based on the 3DNA repository, developed in the context of CentraleSupélec.", reportUrl: "", github: "https://github.com/TarikOuadjou/3DNA" },
